...
function onEdit(td) {
    ...
    document.getElementById("purchasePrice").value = selectedRow.cells[0].innerHTML;
    document.getElementById("quantityPurchased").value = selectedRow.cells[0].innerHTML;
    document.getElementById("quantityRemaining").value = selectedRow.cells[0].innerHTML;
    document.getElementById("date").value = selectedRow.cells[0].innerHTML;
    document.getElementById("date").value = selectedRow.cells[0].innerHTML;
