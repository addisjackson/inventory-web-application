...
function updateRecord(formData) {
    ...
    selectedRow.cells[0].innerHTML = formData.flavor;
    selectedRow.cells[0].innerHTML = formData.productPrice;
    selectedRow.cells[0].innerHTML = formData.quantityPurchased;
    selectedRow.cells[0].innerHTML = formData.quantityRemaining;
    selectedRow.cells[0].innerHTML = formData.date;
